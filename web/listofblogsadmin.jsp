...
<% 
 ...
 "<thead><th>POST DATE</th><th>AUTHER NAME</th><th>IMAGE</th><th>ABOUT</th><th>Update</th><th>Delete</th>"
 + "</thead>"
 + "<tbody>");
 do
 {
 ...
 out.print("<td><a href=update_blog.jsp?id=" 
 + myresult.getString("srno") + ">Update</td>");
 out.print("<td><a href='#' pid="+ myresult.getString("srno") +" class='deletelink'>Delete</td>");
 out.print("</tr>");
