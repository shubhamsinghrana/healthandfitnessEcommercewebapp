...
<body>
		...
		<div class="container">
			...
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
                            <form method="post">
                                        ...
                                        <br>
					<input type="text" placeholder="otp" required=" "  name="otp" >
                                        <br>
 ...
 try
 {
 String query="select * from otp where username=? and otp=?";
 PreparedStatement mystatement=myconnection.prepareStatement(query);
 mystatement.setString(1, email12);
 mystatement.setString(2, otp);
...
// ResultSet myresult2=mystatement2.executeQuery();
   if(myresult.next())
 {
  ...
  session.setAttribute("emailreset",email12);
