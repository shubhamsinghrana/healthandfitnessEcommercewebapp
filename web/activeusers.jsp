...
<div class="key">
 ...
 mystatement.setString(1, "activated");
 ...
 + "<th>Name</th><th>Type</th><th>Plan</th><th>Status</th>"
 + "</thead>"
 + "<tbody>");
 do
 {
...
out.print("<td><a href='#' pid="+ myresult.getString("srno") +" class='deletelink'>Delete User</td>");
 out.print("</tr>");
